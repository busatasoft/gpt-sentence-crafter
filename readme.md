...
## 公開URL (ChatGPT Plusアカウントが必要)
https://chat.openai.com/g/g-eRqmCbaUS-sentensukurahuta

## 使い方
- **今日のおすすめ**: Oxford 5000とOxford Phrase Listからいくつかセンテンスを例示するよ。
- **どんなワードリストを指定できますか？**: センテンス・クラフターにリクエストできるワードリストを紹介するよ
- **as well as sb/sth**: 単語やフレーズを直接指定できるよ（as well... は問い合わせ例だよ）。
- **今後は和訳の代わりにIPAを併記して**: センテンス・クラフターの応答をカスタマイズできるよ。応答の長さを気にしないなら単に「IPAを併記して」でもいいよ。
